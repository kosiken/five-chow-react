...
justifyContent: 'space-around'
      ...
      <Typography>Total N{getTotal(shoppingCartItems)}</Typography>
       <Button color="primary" onClick={clear}>  Clear Cart</Button>  
       <Link to="/checkout"  > <Button variant="contained" color="primary">  Continue</Button>       </Link>
...
export default connect(mapStatetoProps, { removeItemfromCart, clearCart })(CartItems);
